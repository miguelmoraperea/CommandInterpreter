# Set CppUTest Home
PWD = $(shell pwd)
CPPUTEST_HOME = $(PWD)/lib/cpputest

# Set this to @ to keep the makefile quiet
SILENCE = @

#---- Outputs ----#
COMPONENT_NAME = CommandInterpreter
...
#
SRC_FILES += src/CommandInterpreter.c
SRC_DIRS += src
SRC_DIRS += mocks
...
CPPUTEST_OBJS_DIR = CommandInterpreter-obj

CPPUTEST_LIB_DIR = CommandInterpreter-lib
